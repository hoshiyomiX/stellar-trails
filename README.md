...
[![Version](https://img.shields.io/badge/version-8.0.3-blue.svg)](skill/stellar-trails/CHANGELOG.md)
...
**After install:** Invoke via `Skill(command="stellar-trails")` — banner `☄️ STELLAR TRAILS · v8.0.3 · ACTIVE`.
